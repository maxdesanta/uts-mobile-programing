...
class _WeaponPageState extends State<WeaponPage> {
  ...
  List<Map<String, String>> allWeapons = [
    {"name": "Bambu", "image": "assets/bambu.jpg"},
    {"name": "Keris", "image": "assets/keris.jpg"},
    {"name": "Gadok", "image": "assets/gadok.jpg"},
    {"name": "Kujang", "image": "assets/kujang.png"},
    {"name": "Balincong", "image": "assets/balincong.jfif"},
    {"name": "Tombak", "image": "assets/tombak.jfif"},
    {"name": "Kujang", "image": "assets/kujang.png"},
    {"name": "Balincong", "image": "assets/balincong.jfif"},
    {"name": "Tombak", "image": "assets/tombak.jfif"},
    {"name": "Kujang", "image": "assets/kujang.png"},
            ...
            Expanded(
              child: GridView.builder(
                ...
                gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
                  crossAxisCount: 4, // 4 card per row
                  crossAxisSpacing: 10,
                  mainAxisSpacing: 10,
                      ...
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) => WeaponDetailPage(
                            name: weapon['name']!,
                            imagePaths: [weapon['image']!], // Bisa jadi list lebih dari 1
                          ),
                        ),
                      );
                    },
